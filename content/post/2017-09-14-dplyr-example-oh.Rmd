...
`SuperDataScience` has an interesting example of using the advanced dplyr functions (summarise_xx, mutate_xx as well as starts_with() and one_of() ) on top of the `AirPassengers` data. 
